...
async def set_afk(afk_e):
    ...
    if string:
        ...
        await afk_e.edit("IZIN AFK BOSS!")
    if BOTLOG:
        await afk_e.client.send_message(BOTLOG_CHATID, "#AFK\KAMU PERGI AFK!")
    ISAFK = True
...
async def type_afk_is_not_true(notafk):
    ...
    if ISAFK:
        ISAFK = False
        msg = await notafk.respond("SAYA SUDAH BANGKIT.")
        await sleep(2)
        await msg.delete()
        if BOTLOG:
